		...
		<div class="body">
			...
			<div id="body1">
				...
				<div id="q2">
					...
					<input type="text" name="contract" id="d2" class="selec">
				</div>
				<div id="q3">
					<div id="pro01">
					...
					<div id="pro02">
						...
						<input type="text" id="d3" name="pro">
				</div>
				<div id="q4">
					...
					<input type="text" name="Space_type" id="place">
				</div>
				<div id="q5">
					...
					<input type="button" value="미제공" class="a_s"> <input
						...
						<input type="text" name="a_s" id="a_s" class="selec">
				</div>
				<div id="q6">
					...
					<input type="button" value="5년 미만" class="carreer"> <input
						...
						<input type="text" name="carreer" id="carreer" class="selec">
				</div>
				<div id="q7">
					...
					<input type="button" value="금액무관" class="pay"> <input
						...
						<input type="text" name="pay" id="pay" class="selec">
				</div>
				<div id="q8">
					...
					<input type="button" value="없음" class="deposit"> <input
						...
						<input type="text" name="deposit" id="deposit" class="selec">
				</div>
				<div>
			...
			<div id="body2">
				<div id="q1">
					...
					<input type="button" value="표준계약서" class="tag"> <input
						...
						<input type="text" name="tag" id="tag" class="selec">
				</div>
				<div id="q2">
					...
					<div class="l">
						...
						<span id="loc"></span>
						<input type="text" name="location" id="location" class="selec">
				</div>
				<div id="q3">
			...
			<div id="body3">
				<div id="q1">
					...
					<span id="addr"></span>
					<input type="text" name="address" id="address" class="selec">
				</div>
				<div id="q2">
			...
			<div id="body4">
				...
				<div id="q5">
					...
					<input type="button" value="이메일" class="route"> <input
						...
						<input type="text" name="route" id="route" class="selec">
				</div>
				<div id="q6">
