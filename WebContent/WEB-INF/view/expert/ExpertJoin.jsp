...
<body>
	...
	<div id="b">
		<ul id="menuBar">
			<li class="count" id="1"><span>01</span><br> <span
				class="c_t">서비스정보</span></li>
			<li class="count" id="2"><span>02</span><br> <span
				class="c_t">추가정보</span></li>
			<li class="count" id="3"><span>03</span><br> <span
				class="c_t">기본정보</span></li>
			<li class="count" id="4"><span>04</span><br> <span
		...
		<div class="body">
			...
			<br>
			<form action="./ExpertJoin" method="post" id="frm"
				...
				<div id="body1">
					...
					<div id="q5">
						...
						<input type="button" value="미제공" class="a_s"> <input
							...
							type="button" value="3년 이상" class="a_s">
					</div>
					<div id="q6">
				...
				<div id="body4">
					...
					<div id="q3">
						...
						<input type="text" name="address" disabled="disabled" id="address">
						<button id="ad">주소찾기</button>
					</div>
					<div id="q4">
						<span>사업자등록여부를 알려주세요.</span><span class="necessary">필수</span><br>
						<input type="button" value="freelancer" class="r_check"> <input
							type="button" value="individual" class="r_check"> <input
							type="button" value="corporation" class="r_check"><br>
						...
						<div id="individual">
							...
							<input type="text" id="c_num1">-<input type="text"
								id="c_num2">-<input type="text" id="c_num3"><br>
						...
						<div id="corporation">
							...
							<input type="text">-<input type="text">-<input
								...
								value="industry" id="c_regi1"> 네, 등록되어 있습니다.
						</div>
						<div id="brand">
							<span>대리점 혹은 제휴점 코드(번호)를 입력해주세요.</span><br> <input
								type="text"> <span>사업자번호를 입력해주세요.</span><span
								...
								type="checkbox" value="industry" id="c_regi2"> 네, 등록되어
							있습니다.
						</div>
					</div>
					<div id="q5">
