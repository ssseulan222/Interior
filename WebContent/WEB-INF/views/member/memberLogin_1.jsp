...
<meta name="csrf-token" content="TYGnKy6vXD72DSZTfw6kBvJ3R3DRK5L6mgpIyAqeBCXjMJp79xO5vLR6hvnbJ+pSikQVLiCvbc/vEd7aD5Sflw==">
  ...
  <script src="https://d1nyaccf3kuclt.cloudfront.net/assets/v3/components-982ce03bc272a157cc412a53fd812596e921d4bd4b7d0dab7c26a4ec2320cd22.js"></script>
    ...
    <link rel="stylesheet" media="all" href="https://d1nyaccf3kuclt.cloudfront.net/assets/v3/sessions/sign_in-bcc11beec63fa33fd263e414cb60139bb1017bfd9524b15d4cfe3d06971f007a.css">
  <script src="https://d1nyaccf3kuclt.cloudfront.net/assets/v3/users/sessions/new-106bd62bcd23d6622416512f87f5066a1967a69d8913c08bfaf9d1f1063d01a1.js"></script>
...
<div class="sign-in-form-wrap">
  <div class="sign-in-form">
    ...
    <form class="sign-in-form__form" id="new_user" action="/users/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="TYGnKy6vXD72DSZTfw6kBvJ3R3DRK5L6mgpIyAqeBCXjMJp79xO5vLR6hvnbJ+pSikQVLiCvbc/vEd7aD5Sflw==">
      ...
      <section class="sign-in-form__guest-order">
        <button class="sign-in-form__guest-order__title">
          비회원 주문 조회하기
        </button>
        <form class="sign-in-form__guest-order__form sign-in-form__form" action="/orders" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="✓">
          <input type="text" name="order_id" id="order_id" value="" placeholder="주문번호" class="sign-in-form__form__input form-control">
          <input type="text" name="payer_email" id="payer_email" value="" placeholder="이메일" class="sign-in-form__form__input form-control">

          <input type="submit" name="commit" value="주문조회" class="sign-in-form__form__submit btn btn-priority">
</form>      </section>
  </div>
</div>
<footer class="sign-in-form-footer">
  ©<a href="http://bucketplace.co.kr/" target="_blank">Bucketplace Inc</a>. All Rights Reserved
</footer>
</main>
