...
<body>
	<div class="sellerJoinFormDiv">
		<div id="topDiv">
			...
			<h1 id="top2" class="topInfo">상품수정</h1>
		</div>

		<hr>

		<form class="form-horizontal" id="frm" action="./productUpdate" method="post"  enctype="multipart/form-data">
			<div class="session">
			...
			<div class="session">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="brandName" name="brandName" class="form-control" placeholder="제품의 브랜드를 입력해주세요" value="${productDTO.brandName}" >
					</div>
				</div>
