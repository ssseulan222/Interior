...
public class SellerDAO {
	...
	public int sellerJoin(SellerDTO sellerDTO, Connection con) throws Exception{
	...
	public int sellerIdCheck(String id, Connection con) throws Exception{	// id 중복 체크
	...
	public SellerDTO sellerLogin(String id, String pw, Connection con) throws Exception{
	...
	public void sellerFindPw() throws Exception{
		
	}
	
	public int sellerUpdate(SellerDTO sellerDTO, String id, Connection con) throws Exception{
	...
	public int sellerDelete(String id, Connection con) throws Exception{
		int res=0;
	...
	public SellerDTO sellerSelect(String id, Connection con) throws Exception{
